...
#define RED_HELPER_MACRO_GRAB_DEBUG(...) const char* __file0 = __FILE__; size_t __line0 = __LINE__; const char* __function0 = __func__; red_panic(__file0, __line0, __function0, __VA_ARGS__); os_debug_break(); os_get_callstack(__file0, __line0, __function0); os_exit(1);
#define RED_NOT_IMPLEMENTED { RED_HELPER_MACRO_GRAB_DEBUG("Not implemented"); }
#define RED_UNREACHABLE { RED_HELPER_MACRO_GRAB_DEBUG("Unreachable"); }
#define RED_PANIC(...) {  RED_HELPER_MACRO_GRAB_DEBUG(__VA_ARGS__); }
